...
import coderImage from '@/assets/images/coder-desk.png';
  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom, transparent, black_10%, black_70%, transparent)]">
        ...
        <HeroOrbit size={500} rotation={98}>
        ...
        <HeroOrbit size={720} rotation={85}>
          <div className="size-3 rounded-full text-sky-300" />
        </HeroOrbit>
        <HeroOrbit size={520} rotation={-41}>
          <div className="size-2 rounded-full text-sky-300" />
        </HeroOrbit>
      </div>
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-sans text-3xl md:text-4xl text-center font-bold mt-8 tracking-wide">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <button className="inline-flex items-center gap-2 border border-white bg-white text-gray-950 px-6 h-12 rounded-xl">
            <span>📲</span>
            <span className="font-semibold font-sans">Let's Connect</span>
          </button>
        </div>
      </div>
